...
export const CTA: React.FC<PropsWithChildren> = ({ children }) => {
  return (
    <button className="hover:bg-yellow-200 transition-all text-[#151E28] font-bold tracking-wider antialiased text-[1.25rem] w-full sm:max-w-64 bg-CTA shadow-CTA shadow-[0px_0px_10px_-2px] px-5 py-4 border-transparent">
