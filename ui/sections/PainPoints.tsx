    ...
    <section className="flex flex-col relative items-center min-h-[60rem] px-5 bg-section-background">
      ...
      .cls-1Nomad {
        fill: #cc5246;
          ...
          <div className="w-full max-w-[19rem] min-h-[21rem] bg-painPointAccent flex flex-col items-center px-5 pt-10 text-center gap-1">
            <button className="w-full h-full bg-transparent flex flex-col pt-8">
              <p className="text-[1.5rem] text-left flex max-w-[10rem] font-semibold leading-[30px] ml-5">
                Had enough? let's change that!
              </p>
              <p className="mt-32">Arrow svg goes here</p>
            </button>
          </div>
        </div>
      </div>
