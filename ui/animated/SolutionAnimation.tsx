...
export const SolutionAnimation: React.FC = () => {
  ...
  return (
    <div ref={scope2} style={{ opacity: 0 }} className="relative w-full">
      ...
      <svg id="Layer_2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 851.55 785.18">
  <defs>
    <style>{`
      .cls-1, .cls-2 {
        stroke: #333;
    ...
    <clipPath id="clippath">
      <rect className="cls-3" width="851.55" height="785.18" rx="56.84" ry="56.84"/>
    </clipPath>
    <clipPath id="clippath-1">
      <rect className="cls-3" x="-8.55" y="-5.74" width="867.41" height="292.55"/>
    </clipPath>
  ...
  <g id="Layer_1-2" data-name="Layer_1">
    <g>
      <g className="cls-9">
        <rect className="cls-10" x="-2.87" y="-2.33" width="857.18" height="787.51"/>
        <g className="cls-5">
          <rect className="cls-4" x="0" y="-1.83" width="284.53" height="271.35"/>
          <motion.rect className="" style={{fill: color}} x="569.05" y="-1.83" width="284.53" height="293.55"/>
          <rect className="cls-4" x="284.53" y="-1.83" width="284.53" height="271.35"/>
        </g>
        <path className="cls-8" d="M-1.35,264.72h819.59c19.07,0,34.53,15.46,34.53,34.53v374.09H-1.35"/>
        <path className="cls-6" d="M0,363.22h105.39c59.86,0,108.38,48.52,108.38,108.38h0c0,59.86-48.52,108.38-108.38,108.38H0"/>
      </g>
      <line className="cls-2" x1="756.35" y1="94.12" x2="657.26" y2="193.21"/>
      <line className="cls-2" x1="657.26" y1="94.12" x2="756.35" y2="193.21"/>
      <line className="cls-1" x1="73.63" y1="138.72" x2="213.77" y2="138.72"/>
      <rect className="cls-1" x="375.77" y="84.72" width="100.99" height="100.99" rx="5.6" ry="5.6"/>
